...
namespace Kogane.Internal
{
	...
	internal sealed class SearchFieldUI : MonoBehaviour, ISearchFieldUI
	{
		//==============================================================================
		// 変数(SerializeField)
		//==============================================================================
		[SerializeField] private InputField m_inputFieldUI   = default;
		[SerializeField] private Button     m_searchButtonUI = default;
		[SerializeField] private Button     m_deleteButtonUI = default;
