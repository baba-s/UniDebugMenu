...
namespace Kogane.Internal
{
	...
	/// </summary>
	[Serializable]
	internal abstract class LoopListViewUI<TData, TComponent> where TComponent : Component, IScrollItemUI<TData>
	{
		//==============================================================================
		// 変数(SerializeField)
		//==============================================================================
		[SerializeField] private ItemControllerLimited m_view        = default;
