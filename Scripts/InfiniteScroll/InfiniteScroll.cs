...
namespace Kogane.Internal
{
	...
	/// </summary>
	internal class InfiniteScroll : MonoBehaviour
	{
		//==============================================================================
		// 列挙型
		//==============================================================================
		...
		// 変数
		//==============================================================================
		[SerializeField] private RectTransform m_original  = default;
		...
		public float itemScale
		{
			get
			{
				...
				{
					m_itemScale = isVertical ? m_original.sizeDelta.y : m_original.sizeDelta.x
						;
				}
		...
		public void Init( Action<int, GameObject> onUpdate )
		{
			...
			for ( int i = 0; i < m_count; i++ )
			{
				...
				item.anchoredPosition = isVertical ? new Vector2( 0, -itemScale * i ) : new Vector2( itemScale * i, 0 )
					;
		...
		private void Update()
		{
			...
			while ( anchoredPosition - m_diffPreFramePosition < -itemScale * 2 )
			{
				...
				item.anchoredPosition = isVertical ? new Vector2( 0, -pos ) : new Vector2( pos, 0 )
					;
